...
// decision and re-derives the caller's identity from the OS (LOCAL_PEERCRED,
// checked against the console user), so this binary carries no privilege of
// its own; it is a thin request/response front end.
package main
